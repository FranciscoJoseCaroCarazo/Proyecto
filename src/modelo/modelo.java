...
public class modelo extends database{
    ...
    public boolean Janiadirjugador(String id, String nombre , String apellido, String nacionalidad, String fecha)
    {
            //Se arma la consulta
    ...
    public boolean Jnuevoequipo(String nombre, String anio , String estadio)
    {
            //Se arma la consulta
